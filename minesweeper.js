const minesweeperTranslations = {
    ru: {
        ...
        controls1: "ЛКМ - открыть клетку",
        controls2: "ПКМ - поставить флаг",
        controls3: "Средняя кнопка - вопрос",
        goalTitle: "ЦЕЛЬ",
        goal1: "Откройте все клетки, не содержащие мины",
        goal2: "Используйте цифры для определения мин",
        pauseTitle: "ИГРА НА ПАУЗЕ",
        pauseTimeLabel: "Время:",
    ...
    en: {
        ...
        timeLabel: "TIME",
        easyBtn: "BEGINNER",
        mediumBtn: "INTERMEDIATE",
        hardBtn: "EXPERT",
        controlsTitle: "CONTROLS",
        controls1: "LMB - reveal cell",
        controls2: "RMB - place flag",
        controls3: "Middle click - question mark",
        goalTitle: "GOAL",
        goal1: "Reveal all cells without mines",
        goal2: "Use numbers to identify mines",
    ...
    de: {
        ...
        timeLabel: "ZEIT",
        easyBtn: "ANFÄNGER",
        mediumBtn: "FORTGESCHRITTEN",
        hardBtn: "EXPERTE",
        controlsTitle: "STEUERUNG",
        controls1: "LMT - Feld öffnen",
        controls2: "RMT - Flagge setzen",
        controls3: "Mittlere Taste - Fragezeichen",
        goalTitle: "ZIEL",
        goal1: "Öffne alle felder ohne Minen",
        goal2: "Verwende Zahlen um Minen zu identifizieren",
...
let currentLang = localStorage.getItem('minesweeper_language') || 'ru';

function t(key, replacements = {}) {
    let text = minesweeperTranslations[currentLang]?.[key] || minesweeperTranslations.ru[key];
...
function updateMinesweeperUILanguage() {
    const elements = ['minesLabel', 'timeLabel', 'controlsTitle', 'controls1', 'controls2', 'controls3', 'goalTitle', 'goal1', 'goal2', 'pauseTitle', 'pauseTimeLabel', 'resumeText'];
    ...
    if (easyBtn) easyBtn.textContent = t('easyBtn');
    if (mediumBtn) mediumBtn.textContent = t('mediumBtn');
    if (hardBtn) hardBtn.textContent = t('hardBtn');
